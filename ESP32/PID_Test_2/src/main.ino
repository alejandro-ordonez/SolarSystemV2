...
float b[] = {0.00156833279540069, 0.00156833279540069};
float a[] = {1.000000000000000, -0.996863334409199};
float lp_in1[2];
float lp_out1[2];
...
// PID Constants
double KP = 1038.2412, KD = 2159.9936, KI = 66.0449;
// Error constants
...
float readISensor()
{
  ...
  return 0.1041*filterISensor.calc_out(averageAnalogReading(60, ISensor))-15.877;
}
///////////////////////////////////////////////////////////////
...
float readVSensor()
{
  ...
  return 0.0264* filterVoltage.calc_out(averageAnalogReading(60, VS1)) +2.4251;
}
